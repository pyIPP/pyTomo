...
class COMPASS(Tokamak):
    def __init__(self, input_diagn, input_parameters,  only_prepare = False  ):
        ...
        path = 'geometry/compass/'+input_diagn
    ...
    def VIS(self):
        ...
        self.tvec  = tvec
        data , tmp, G_orig = phantom_generator(self, tvec, self.nx, self.ny, 'Hollow')
    ...
    def Camera(self):
        ...
        if not self.artif_data:
            ...
            self.min_error = mean(data[:,0]) /  mquantiles( data, 0.99)
            ...
            FOV = rot270(load( self.geometry_path + '/fov.npy' )) == 0
    ...
    def Bolo(self):
        ...
        self.calb_0 = [1,1,1,0.68,0.12, 0.1]

        self.default_calb = "none"
        


    def convert_mag_equilibrium(self,magnet_field, periodical = True):
        """
    ...
    def load_mag_equilibrium(self):
        ...
        magx, magy = self.convert_mag_equilibrium(magnet_field)
        #magx = magx[:,::-1]
        #magy = magy[:,::-1]
